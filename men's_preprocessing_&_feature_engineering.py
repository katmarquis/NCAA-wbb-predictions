# -*- coding: utf-8 -*-
"""Men's Preprocessing & Feature Engineering

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RkHdfZtgqK2usmn-Z4PHNXO8DfdO-91W
"""
...
path = "/content/drive/MyDrive/Undergrad/Smore Year/Classes/BEM 120/mdata/"

MTourneyData = pd.read_csv(path + 'MNCAATourneyDetailedResults.csv')
MRegularSeasonData = pd.read_csv(path + 'MRegularSeasonDetailedResults.csv')
all_games_data = pd.concat([MRegularSeasonData, MTourneyData])
...
for N in n:
  ...
  df_avg_matchups.to_csv("Mavg_matchups_n={}.csv".format(N))
  files.download("Mavg_matchups_n={}.csv".format(N))